...
from dynamic_network_architectures.building_blocks.unet_featuredecoder import UNetFeatureDecoder
...
class NoEmbedding_Featured_UNet(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
        ...
        self.decoder = UNetFeatureDecoder(self.encoder, num_classes, n_conv_per_stage_decoder, deep_supervision,
                                   nonlin_first=nonlin_first)
    def forward(self, x):
